...
- Pearson correlation and pooled OLS linear regression (`scipy`, `scikit-learn`) to test whether Okun's Law holds across the dataset
...
- A Pearson correlation and OLS regression confirmed Okun's Law holds across most economies,
